...
| `--timeout`           | `int`  | `604800`    | 預設會話超時時間（秒，默認一週）      |
...
export MCP_FEEDBACK_TIMEOUT=604800
...
**版本**: 2.4.3 **最後更新**: 2025 年 6 月 14 日 **維護者**: Minidoracat **新功
能**: 音效通知系統、會話管理重構、智能記憶功能、一鍵複製 **完成**: 架構文檔體系
已更新完成，包含 v2.4.3 版本的完整技術文檔和部署指南。
